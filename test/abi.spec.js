  ...
  describe("test erc20 abi", function () {
    ...
    describe("test encode & decode", function () {
      ...
      it("test get abi item", function () {
        const data = inst.getAbiItem("transfer", "0x533243557dfdc87ae5bda885e22db00f87499971", "30000000000000000")
      ...
      it("throw error if function name does not exist", function () {
        expect(() => inst.getAbiItem("transfer1", "533243557dfdc87ae5bda885e22db00f87499971", "30000000000000000")).throw("The contract doesn't contain \"transfer1\" function");
      })
